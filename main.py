...
class Menses:
    ...
    def __init__(self, name, menses_period):
        ...
        self.menstrual_classes_period = [4, 4, 5, 1, 4, 10]  # 每个阶段对应的时间长度，应当自己去估计，这里采用均值
        self.name = name
...
class WeMessage:
    ...
    def start(self):
        ...
        # 判断时间
        if "08:00:00" < server_time < "11:00:00":
...
if __name__ == "__main__":
    ...
    """‘’‘’‘’‘’‘’‘’‘’‘’‘’‘’‘’‘’以下密钥均已做修改，无法使用，需自己去申请 ‘’‘’‘’‘’‘’‘’‘’‘’‘’‘’‘’‘’‘’‘’"""

    tianapi_api = '54601312395c6d7fe2d8ee6'  # 第三方接口的key
    """从微信公众平台获取的相关密钥"""
    client_info = {
        "APP_ID": 'wxaef9d01eca',
        "APP_SECRET": 'ef79f1e3ea7b7c60fa1502a',
        "USER_ID": ['omr1N5l9KfrJET3qrGs', 'omr1N5sNuZ0At5SgWK9aw'],
        "TEMPLATE_ID": {
            'daily_id1': 'Kyyl3f7JxD74lf_AJ6cLR0qTY-4',
            'daily_id2': 'MJ0faGfHrbNNRytyTS6awxQV6iNI',
            'star_id':   'vxbFxhPLsjnsZYAfJicOsdjM-ds9c9U',
            'night_id':  'Z60JmU38hQ80nB_jIFTHUi7T0',
            'story_id':  '5I4PnlNUA84BuMNF7K_SUi0',
        }
    }
    WeMessage(user0, user1, client_info, tianapi_api)

    '''’‘’‘’‘’‘’‘’‘’‘’‘以下是需要填到微信公众号测试平台的temp  获取到对应的id 后，填入上方 template——id’‘’‘’‘’‘'''
    """   daily_id1
